...
KILOVOLT_AMPERE_HOUR = {ElectricScale.KILOVOLT_AMPERE_HOUR}
WATT = {ElectricScale.WATT}
PULSE_COUNT = {ElectricScale.PULSE_COUNT}
VOLT = {ElectricScale.VOLT}
AMPERE = {ElectricScale.AMPERE}
POWER_FACTOR = {ElectricScale.POWER_FACTOR}
KILOVOLT_AMPERE_REACTIVE = {ElectricScale.KILOVOLT_AMPERE_REACTIVE}
KILOVOLT_AMPERE_REACTIVE_HOUR = {ElectricScale.KILOVOLT_AMPERE_REACTIVE_HOUR}
CUBIC_METER = {GasScale.CUBIC_METER, WaterScale.CUBIC_METER}
CUBIC_FEET = {GasScale.CUBIC_FEET, WaterScale.CUBIC_FEET}
US_GALLON = {WaterScale.US_GALLON}
PULSE_COUNT = {GasScale.PULSE_COUNT, WaterScale.PULSE_COUNT}
