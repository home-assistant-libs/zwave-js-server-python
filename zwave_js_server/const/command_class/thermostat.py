...
THERMOSTAT_AIR_TEMP_PROPERTY = "Air temperature"
THERMOSTAT_SOIL_TEMP_PROPERTY = "Soil temperature"
THERMOSTAT_CURRENT_TEMP_PROPERTY = THERMOSTAT_AIR_TEMPERATURE_PROPERTY
